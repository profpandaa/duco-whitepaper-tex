...
\definecolor{duco_orange}{HTML}{b45f06} % ff4112
\definecolor{duco_white}{HTML}{fafafa}
\definecolor{sun_yellow}{HTML}{ffb412}
\definecolor{title_orange}{HTML}{ff9900}
...
\begin{raggedleft}
    ...
    \small \textcolor{whitepaper_purple}{rev. 8.1} \\[0.3cm]
\end{raggedleft}

\large \bold{title_orange}{The Duino-Coin Team} \\
\normalsize \textcolor{revox_gray}{support@duinocoin.com} \\
\textcolor{whitepaper_gray}{duinocoin.com}

\begin{justify}
\section*{\bold{title_orange}{What is Duino-Coin?}}
...
\section*{\bold{title_orange}{Technical specifications}}
\vspace*{-5pt}
...
\newpage
\section*{\bold{title_orange}{Form}}
...
\section*{\bold{title_orange}{Uniqueness}}
...
\section*{\bold{title_orange}{Mining}}
...
\section*{\bold{title_orange}{Rewards}}
...
\section*{\bold{title_orange}{Efficiency drop}}
...
\section*{\bold{title_orange}{Centralization}}
...
\section*{\bold{title_orange}{Decentralization}}
...
\newpage
\section*{\bold{title_orange}{Features of Kolka}}
...
\newpage
\section*{\bold{title_orange}{Exchanges}}
...
\section*{\bold{title_orange}{Sources and useful links}}
Website: \url{https://duinocoin.com}\\
GitHub: \url{https://github.com/duino-coin/duino-coin}\\
...
FAQ: \url{https://github.com/duino-coin/duino-coin/wiki/FAQ}\\
